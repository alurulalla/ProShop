...
export const userListReducer = (state = { users: [] }, { payload, type }) => {
  switch (type) {
...
export const useDeleteReducer = (state = {}, { payload, type }) => {
  switch (type) {
...
export const userUpdateReducer = (state = { user: {} }, { payload, type }) => {
  switch (type) {
