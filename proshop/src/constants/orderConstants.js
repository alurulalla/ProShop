...
export const ORDER_LIST_MY__REQUEST = 'ORDER_LIST_MY__REQUEST';
export const ORDER_LIST_MY__SUCCESS = 'ORDER_LIST_MY__SUCCESS';
export const ORDER_LIST_MY__FAIL = 'ORDER_LIST_MY__FAIL';
export const ORDER_LIST_MY__RESET = 'ORDER_LIST_MY__RESET';
